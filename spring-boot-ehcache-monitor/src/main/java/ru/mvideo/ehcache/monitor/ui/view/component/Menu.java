...
public class Menu extends CssLayout {
    private static final long serialVersionUID = 5652778553530373099L;

    static final String CACHE_PARAMETER_KEY = "cache";
    private static final String VALO_MENUITEMS = "valo-menuitems";
    private static final String VALO_MENU_TOGGLE = "valo-menu-toggle";
    private static final String VALO_MENU_VISIBLE = "valo-menu-visible";
    public static final String ALL_CACHES = "All caches";
    ...
    private void initCacheInfo() {
        addViewButton("", ALL_CACHES, VaadinIcons.LIST);
